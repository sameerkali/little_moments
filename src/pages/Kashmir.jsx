    ...
    <>
      ...
      <div className="flex bg-[#F7F5EC] justify-between border-2 sam_shadow_1 m-16 rounded-xl  p-5 ">
        <div className="">
          <p>
            {Details[3]?.rating}{" "}
            <span className="text-gray-400">(11k Reviews)</span>
          </p>
          <p className="text-[3.4rem] font-bold">{Details[3]?.title}</p>
          <p className="font-bold">{Details[3]?.description}</p>

          <div className="flex flex-row pt-7 font-bold pb-7 ">
            <p className=" pr-5 flex flex-row">
              <FaLocationDot /> {Details[3]?.location}
            </p>
            <p className="pl-5 flex flex-row ">
              <FaPhone /> {Details[3]?.phone}
            </p>
          </div>
        </div>
        <hr />
        <div className="right">
          ...
          <p className="mt-7 font-bold">{Details[3]?.date}</p>
        </div>
      </div>
    </>
  );
